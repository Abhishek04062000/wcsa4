...
public class NikeLoginPage {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.cssSelector("input[id='e0ed19e1-fdf9-4468-8d6e-f643e6e03403']")).sendKeys("abhisheksingh00999@gmail.com");
		//driver.findElement(By.id("28279ae1-2569-4d70-980d-e280d7d00c7f")).sendKeys("123xyz");
		Thread.sleep(2000);
		driver.findElement(By.cssSelector("input[id='a0c3675b-de87-4fc8-8267-6ce3d64248fd']")).sendKeys("Louisvuitton@04");
		Thread.sleep(2000);
